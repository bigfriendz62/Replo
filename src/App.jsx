  ...
  return (
    <div style={sectionWrap}>
      <div style={{ display: "flex", justifyContent: "space-between", alignItems: "flex-start", marginBottom: 4 }}>
        <div>
          <div style={{ fontSize: 11, color: "#556655", letterSpacing: "0.15em", textTransform: "uppercase", fontFamily: "monospace", marginBottom: 6 }}>Welcome back</div>
          <h2 style={{ ...sectionTitle, marginBottom: 4 }}>{profile.biz || "Your Business"}</h2>
        </div>
